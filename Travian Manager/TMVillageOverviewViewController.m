...
- (void)buildCells {
    ...
    if (incoming.count > 0)
        [sections addObject:@{@"header" : NSLocalizedString(@"Incoming", @"Movements related"),
                @"cells" : incoming}];
    if (outgoing.count > 0)
        [sections addObject:@{@"header" : NSLocalizedString(@"Outgoing", @"Movements related"),
                @"cells" : outgoing}];
    if (other.count > 0)
        [sections addObject:@{@"header" : NSLocalizedString(@"Other Movements", @"Movements related"),
                @"cells" : other}];
